...
plot "arraivalrate_command_date_2.csv" using 0:3:2:xticlabels(1) with boxes lc variable,\
 "arraivalrate_command_date_2.csv" using 0:($3+0.1):(sprintf("%3.0f",$3)) with labels notitle font "Arial,15"

set output "./output-arraivalrate_command.png"
replot
